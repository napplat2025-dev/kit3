...
const team = [
  ...
  { initials: 'AM', name: 'Alfred Melkon', title: 'Team Member', color: 'var(--amber)', bg: 'var(--amber-light)', bio: 'A dedicated professional bringing expertise and passion to the Kitchen Three family. Alfred contributes his skills and energy to supporting the team across client engagements and operational delivery.', credentials: ['Kitchen Three Team Member'], focus: 'Client support and operational delivery.' },
  { initials: 'KZ', name: 'Karim Zorkani', title: 'Team Member', color: 'var(--coral)', bg: 'var(--coral-light)', bio: 'A committed professional contributing drive and vision to the Kitchen Three mission. Karim Zorkani brings dedication and a forward-thinking approach to every project he is involved with.', credentials: ['Kitchen Three Team Member'], focus: 'Project support and business development.' },
]
