...
const team: Member[] = [
  ...
  { initials: 'AM', name: 'Alfred Melkon', title: 'Founding Advisor & Operating Partner', color: 'var(--amber)', bg: 'var(--amber-light)', pdf: '/team/alfred-melkon.pdf', bio: 'Alfred Melkon has been a mentor to Karim Fayed and a foundational advisor to Kitchen Three since its inception in November 2013 — a guiding hand behind the company\'s growth, operating model, and strategic direction for over a decade.\n\nHe brings thirty-six years of building and fixing food & beverage businesses: a decade at McDonald\'s Egypt taking multi-unit operations to global QSR standard; General Manager of Cilantro, where he turned an 84-store chain from loss-making to profitable in 18 months and led its exit to a strategic investor; Business Unit Head across three brands at The Bakery Shop Holding; and co-founder of Molly\'s Bakery, scaled from zero to eight stores in 30 months. Certified in advanced operations and supply chain management across Manila, Chicago, and Frankfurt, Alfred brings world-class operational discipline to every Kitchen Three engagement.', credentials: ['Founding Advisor, Kitchen Three — since November 2013', 'General Manager, Cilantro — 84+ stores, loss to profit in 18 months', "Co-Founder, Molly's Bakery — 8 stores in 30 months", 'Business Unit Head, The Bakery Shop Holding', "Operations Manager, McDonald's Egypt — 10 years", 'Bachelor of International Hospitality Management, Alexandria University'], focus: 'Founding advisory, operations, turnaround, and multi-unit growth.' },
          ...
          <div className="advisory-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
            {team.slice(2).map(m => (
              <div key={m.name} style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 4, padding: '28px 24px' }}>
                ...
                {m.pdf && (
                  <a href={m.pdf} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 14, fontSize: 11, color: m.color, letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 600, textDecoration: 'none' }}>
                    View Full Profile →
                  </a>
                )}
              </div>
