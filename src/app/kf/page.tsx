  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: bg, color: dark, overflowX: 'hidden' }}>
      ...
      <section style={{ textAlign: 'center', padding: '80px 24px', background: bg3, position: 'relative', overflow: 'hidden' }}>
        ...
        <button onClick={() => setModalOpen(true)} style={{ background: `linear-gradient(135deg, ${flame}, ${ember})`, color: '#fff', border: 'none', padding: '16px 40px', fontSize: 13, letterSpacing: 1, textTransform: 'uppercase', cursor: 'pointer', borderRadius: 2, fontFamily: 'inherit', fontWeight: 500 }}>
          Start Your Discovery Brief
        </button>
      </section>
