...
import { flame, ember, gold, bg, bg2, dark, muted, border, KFLogo, ModalScreen, whatsappURL, emailURL, pageOptions, featureOptions, vibeOptions, budgetOptions, timelineOptions } from './KFConstants'
...
export default function KFModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div onClick={e => { if (e.target === e.currentTarget) onClose() }}
      ...
      <div style={{ background: bg, borderRadius: 6, width: '100%', maxWidth: 600, maxHeight: '90vh', overflowY: 'auto', boxShadow: '0 24px 60px rgba(26,18,8,0.25)' }}>
        ...
        {screen === 'gate' && (
          <div style={{ padding: '40px 32px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div onClick={() => setScreen('brief-choice')} style={cardStyle}
              ...
              <div onClick={() => { setScreen('questionnaire'); setStep(1) }} style={cardStyle}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = flame; (e.currentTarget as HTMLElement).style.background = `rgba(232,84,10,0.04)` }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = border; (e.currentTarget as HTMLElement).style.background = bg }}>
                <div style={{ fontSize: 36, marginBottom: 12 }}>📋</div>
          ...
          <div style={{ padding: '40px 32px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <a href={emailURL} style={{ textDecoration: 'none' }}>
                <div style={{ ...cardStyle, borderColor: '#4285F4' }}
            ...
            <p style={{ fontSize: 11, color: muted, marginTop: 24, lineHeight: 1.6 }}>We'll respond within 48 hours with a tailored proposal.</p>
          </div>
        )}
        ...
        {screen === 'q-success' && (
          <div style={{ textAlign: 'center', padding: '60px 32px' }}>
            ...
            <button onClick={onClose} style={{ background: flame, color: '#fff', border: 'none', padding: '12px 28px', fontSize: 13, cursor: 'pointer', borderRadius: 2, fontFamily: 'inherit' }}>
              Back to Site
            </button>
          </div>
        )}
